...
<body>
  <div class="container section" id="simulador">
    <h1>⚡ Simulador de Condensador</h1>
    ...
    <div class="buttons">
      <button class="btn-orange" onclick="capturar()">📊 Capturar</button>
      <button class="btn-green" onclick="graficar()">📈 Gráfica</button>
      <button class="btn-red" onclick="limpiar()">🗑️ Limpiar</button>
      <button class="btn-blue" onclick="verExperimento()">🔬 Experimento</button>
    </div>
    ...
    <div class="simulator">
      ...
      <div class="result">
        Campo Eléctrico: <span id="campo">0.00 V/m</span>
      </div>
    </div>
  ...
  <div class="container section hidden" id="experimento">
    <h1>⚡ Experimento: Condensador de Placas</h1>
    
    <div class="buttons">
      <button class="btn-blue" onclick="volverSimulador()">◀️ Volver</button>
    </div>

    <h2>📊 Datos Experimentales</h2>
    
    <h3>Campo Eléctrico vs Voltaje (d = 6 mm)</h3>
    <div class="info-box">
      <strong>Configuración:</strong> Distancia fija en 6 mm, variando el voltaje.
    </div>
    ...
    <h3>Campo Eléctrico vs Distancia (V = 1 kV)</h3>
    <div class="info-box">
      <strong>Configuración:</strong> Voltaje fijo en 1 kV, variando la distancia.
    </div>
    ...
    <h2>🔋 Capacitancia y Carga</h2>
    <div class="info-box">
      <strong>Área:</strong> 0.01 m² (10 cm × 10 cm)<br>
      <strong>Capacitancia teórica:</strong> C ≈ 14.8 pF<br>
      <strong>Densidad de carga:</strong> σ ≈ 1.32×10⁻⁶ C/m²<br>
      <strong>Carga total:</strong> Q ≈ 13.2 nC
    </div>
  </div>
  ...
  <script>
    ...
    function capturar() {
      ...
      alert('✅ Dato capturado');
    }

    function graficar() {
      if (datos.length === 0) {
        alert('⚠️ No hay datos para graficar');
        return;
      }
